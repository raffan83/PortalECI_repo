...
public class GestioneQuestionarioBO {
	...
	public static final String[] GLOBAL_PLACEHOLDERS = new String[]{"TECNICO_VERIFICATORE","QUAL_TV","NUMERO_VERBALE","CLIENTE_UTILIZZATORE","INDIRIZZO_CLIENTE_UTILIZZATORE","CLIENTE","INDIRIZZO_CLIENTE",
																	"ATT_MATRICOLA","ATT_N_FABBRICA","ATT_DESCRIZIONE","ATT_ANNO_COSTRUZIONE","ATT_FABBRICANTE","ATT_MODELLO","ATT_SETTORE_IMPIEGO","INDIRIZZO_UTILIZZATORE_VIE","ESERCENTE",
																	"STR_MARCA","STR_MOD","STR_MATR", "STR_SCADENZA","STR_ULT_TAR","DATA_VERIFICA","DATA_PROSS_VERIFICA","DATA_VER_INTEGRITA","DATA_PROSS_VER_INTEGRITA", 
																	"DATA_VER_INTERNA", "DATA_PROSS_VER_INTERNA","ORE_UOMO", "MATRICOLA_VIE", "TIPO_VERIFICA_VIE", "TIPO_VERIFICA_VAL", "TIPO_VERIFICA_VAL_GVR",
																	"STR_NUMERO_CERT", "COM_PROV", "DATA_CONFERMA", "FIRMA_VERIFICATORE","RUOLO_RIESAME","DATA_RIESAME", "FIRMA_RIESAME", "ESITO_VERIFICA", "QR_CODE", "DATA_VERIFICA_MULTIPLA", "POTENZA_IMPIEGATA"};
